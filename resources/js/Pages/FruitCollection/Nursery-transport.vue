                                                        ...
                                                        <div class="flex flex-col rounded-md shadow-lg px-3 py-2 pt-3">
                                                            ...
                                                            <div v-if="SelectedOne"
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    v-model="form.quantity" placeholder="Tree number">
                                                                <button
                                                            ...
                                                            <table class="table table-hover text-nowrap mt-6">
                                                                <thead>
                                                                    <tr>
                                                                        <th>ID</th>
                                                                        <th>Tree Number</th>
                                                                        <th>Kg Collected From Tree</th>
                                                                        <th>Kg Collected From Farm</th>
                                                                        <th>Kg Collected for Nursery Transport</th>
                                                                        <th>Action</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr v-for="$tree in Jobcard.trees" :key="$tree.id">
                                                                        ...
                                                                        <td>{{ $tree.fruit_collection_quantity }}</td>
                                                                        <td>{{ $tree.farm_collection_quantity }}</td>
                                                                        <td>{{ $tree.nursery_transport_quantity }}</td>
                                                                        <td>
                                                                            <i @click="selected($tree.id)"
...
export default {
    ...
    methods: {
        update() {
            this.form.patch(`/save/nursery-transport-quantity/${this.form.SelectedId}`, {
