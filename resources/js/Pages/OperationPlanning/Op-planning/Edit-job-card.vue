                                        ...
                                        <div class="p-4 bg-white border-b border-gray-200">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div v-if="Jobcard.childactivity.child_number >= 3" class="col-sm-12 class rounded-md shadow-lg px-6 py-4 mt-2 mb-4">
                                                    <Record :Data="Jobcard" :Activity="'Operational Planning'" :childNumber="2" :TimelineIndex="1"/>
                                                </div>

                                                <div v-if="Jobcard.childactivity.child_number >= 4" class="col-sm-12 class rounded-md shadow-lg px-6 py-4 mt-2 mb-4">
                                                    <Record :Data="Jobcard" :Activity="'Review and Communication'" :childNumber="3" :TimelineIndex="2"/>
                                                </div>

                                                <div v-if="Jobcard.childactivity.child_number >= 5" class="col-sm-12 class rounded-md shadow-lg px-6 py-4 mt-2 mb-4">
                                                    <Record :Data="Jobcard" :Activity="'Financial Planning'" :childNumber="4" :TimelineIndex="3"/>
                                                </div>
                                               
                                                <div v-if="Jobcard.childactivity.child_number >= 6" class="col-sm-12 class rounded-md shadow-lg px-6 py-4 mt-2 mb-4">
                                                    <Record :Data="Jobcard" :Activity="'New Review of the Ms project plan'" :childNumber="5" :TimelineIndex="4"/>
                                                </div>

                                                <div v-if="Jobcard.childactivity.child_number >= 7" class="col-sm-12 class rounded-md shadow-lg px-6 py-4 mt-2 mb-4">
                                                    <Record :Data="Jobcard" :Activity="'Approval of the Ms project plan'" :childNumber="6" :TimelineIndex="5"/>
                                                </div>

                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        <div class="form-group">
                                                            <label>{{ Jobcard.childactivity.child_title }} Start Date:</label>
